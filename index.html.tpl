...
<!include_script "jsd/items.js">
 ...
 <body>
  ...
  <div id="halp">
    ...
    <p>If you're a smart cookie, you'll notice the data itself is <a href="https://github.com/kentfredric/albion-calc/blob/master/index.html#L292"> reasonably well laid out</a> and you might know what it takes to fix it with a <a href="https://github.com/kentfredric/albion-calc/pulls">Pull Request</a></p>
  </div>
